            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        case ('id'): ?>
                        <img src="<?php echo e(URL::asset('build/images/flags/id.svg')); ?>" class="me-2 rounded" alt="Header Language" height="20">
                        <?php break; ?>
                        <?php case ('ru'): ?>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="<?php echo e(url('index/ae')); ?>" class="dropdown-item notify-item language" data-lang="ae" title="Arabic">
                            <img src="<?php echo e(URL::asset('build/images/flags/ae.svg')); ?>" alt="user-image" class="me-2 rounded" height="20">
                            <span class="align-middle">Arabic</span>
                        </a>

                        <!-- item-->
                        <a href="<?php echo e(url('index/id')); ?>" class="dropdown-item notify-item language" data-lang="id" title="Indonesia">
                            <img src="<?php echo e(URL::asset('build/images/flags/id.svg')); ?>" alt="user-image" class="me-2 rounded" height="20">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="<?php if(Auth::user()->avatar != ''): ?><?php echo e(URL::asset('images/users/' . Auth::user()->avatar)); ?><?php else: ?><?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?><?php endif; ?>" alt="Header Avatar">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('profileSettings')); ?>"><span class="badge bg-success-subtle text-success mt-1 float-end">New</span><i class="mdi mdi-cog-outline text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Settings</span></a>
...
<?php /**PATH /Users/siddiq/Desktop/WEB DEV/LISTING/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>