                            ...
                            <div class="d-flex align-items-center mb-3">
                                <div class="flex-shrink-0 avatar-sm">
                                    <div class="avatar-title bg-light text-primary rounded-3 fs-18">
                                        <?php if($history->is_Phone == 1): ?>
                                        <i class="ri-smartphone-line"></i>
                                        <?php elseif($history->is_Tablet == 1): ?>
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="text-muted mb-0"><?php echo e($history->ip_address); ?> - Los Angeles, United States - <?php echo e(\Carbon\Carbon::parse($history->created_at)->diffForHumans()); ?></p>
                                </div>
                                <div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/siddiq/Desktop/WEB DEV/LISTING/resources/views/users/profile-settings.blade.php ENDPATH**/ ?>