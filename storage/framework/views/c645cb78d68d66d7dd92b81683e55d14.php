                            ...
                            <table class="table align-middle table-nowrap mb-0" id="userTable">
                                ...
                                <tbody class="list form-check-all">
                                    <tr >
                                        ...
                                        <td class="company_name"><?php echo e(auth()->user()->detail ? auth()->user()->detail->company : '-'); ?></td>
                                        <td class="email_id"><?php echo e(auth()->user()->email); ?></td>
                                        <td class="phone"><?php echo e(auth()->user()->detail ? auth()->user()->detail->phone : '-'); ?></td>
                                        <td class="designation"><?php echo e(auth()->user()->detail ? auth()->user()->detail->designation : '-'); ?></td>
                                        <td class="skills">
                                            <?php 
                                        ...
                                        <td class="last_updated"><?php echo e(Carbon\Carbon::parse(auth()->user()->updated_at)->format('d M, Y')); ?> <small
                                                class="text-muted"> <?php echo e(Carbon\Carbon::parse(auth()->user()->updated_at)->format('h:i A')); ?>.</small></td>
                                        <td>
                                ...
                                <div class="modal-body p-5 text-center">
                                    ...
                                    <div class="mt-4 text-center">
                                        ...
                                        <div class="hstack gap-2 justify-content-center remove">
                                            ...
                                            <input type="hidden" id="_auth_id" name="_auth_id" value="<?php echo e(Auth::user()->id); ?>">
        ...
        <div class="col-xxl-3">
            <div class="card" id="contact-view-detail">
                <div class="card-body text-center">
                    ...
                    <h5 class="mt-4 mb-1"><?php echo e(Auth::user()->detail ? Auth::user()->detail->f_name ." ". Auth::user()->detail->l_name : Auth::user()->name); ?></h5>
                    <p class="text-muted"><?php echo e(Auth::user()->email); ?></p>

                    <ul class="list-inline mb-0">
                        <li class="list-inline-item avatar-xs">
                            <a href="tel:<?php echo e(Auth::user()->detail ? Auth::user()->detail->phone : ''); ?>" class="avatar-title bg-success-subtle text-success fs-15 rounded">
                                <i class="ri-phone-line"></i>
                            </a>
                        </li>
                        <li class="list-inline-item avatar-xs">
                            <a href="mailto:<?php echo e(Auth::user()->email); ?>" class="avatar-title bg-danger-subtle text-danger fs-15 rounded">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted mb-4"><?php echo e(Auth::user()->detail ? Auth::user()->detail->biography : "Hello, I'm ". Auth::user()->name .", The most effective objective is one that is tailored
                        ...
                        <table class="table table-borderless mb-0">
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo e(Auth::user()->detail ? Auth::user()->detail->designation : '-'); ?></td>
                                </tr>
                                <tr>
                                    <td class="fw-medium" scope="row">Full Name</td>
                                    <td><?php echo e(Auth::user()->detail ? Auth::user()->detail->f_name ." ". Auth::user()->detail->l_name : Auth::user()->name); ?></td>
                                </tr>
                                <tr>
                                    <td class="fw-medium" scope="row">Day of Birth</td>
                                    <td><?php echo e(Auth::user()->detail ? \Carbon\Carbon::parse(Auth::user()->detail->dob)->format('d M, Y') : '-'); ?></td>
                                </tr>
                                <tr>
                                    <td class="fw-medium" scope="row">Age</td>
                                    <td><?php echo e(Auth::user()->detail ? \Carbon\Carbon::parse(Auth::user()->detail->dob)->age : '-'); ?> Years</td>
                                </tr>
                                <tr>
                                    <td class="fw-medium" scope="row">Address</td>
                                    <td><?php echo e(Auth::user()->detail ? Auth::user()->detail->address : '-'); ?></td>
                                </tr>
                                <tr>
                                    <td class="fw-medium"></td>
                                    <td><?php echo e(Auth::user()->detail ? Auth::user()->detail->city : '-'); ?>, <?php echo e(Auth::user()->detail ? Auth::user()->detail->country : '-'); ?>. <?php echo e(Auth::user()->detail ? Auth::user()->detail->zip : '-'); ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(Auth::user()->detail ? Auth::user()->detail->phone : '-'); ?></td>
                                </tr>
                                <tr>
                                    <td class="fw-medium" scope="row">Website</td>
                                    <td><?php echo e(Auth::user()->detail ? Auth::user()->detail->website : '-'); ?></td>
                                </tr>
                                <tr>
                                    <td class="fw-medium" scope="row">Skills</td>
                                    <td>
                                        <?php $__currentLoopData = explode(',', Auth::user()->detail ? Auth::user()->detail->skills : ''); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="badge bg-secondary-subtle text-secondary"><?php echo e($skill); ?></span>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(\Carbon\Carbon::parse(Auth::user()->created_at)->format('d M, Y')); ?> <small class="text-muted"><?php echo e(\Carbon\Carbon::parse(Auth::user()->created_at)->format('h:i A')); ?>.</small> | <span class="text-muted"><?php echo e(\Carbon\Carbon::parse(Auth::user()->created_at)->diffForHumans()); ?></span></td>
                                </tr>
                                <tr>
                                    <td class="fw-medium" scope="row">Last Updated</td>
                                    <td><?php echo e(\Carbon\Carbon::parse(Auth::user()->updated_at)->format('d M, Y')); ?> <small class="text-muted"><?php echo e(\Carbon\Carbon::parse(Auth::user()->updated_at)->format('h:i A')); ?>.</small> | <span class="text-muted"><?php echo e(\Carbon\Carbon::parse(Auth::user()->updated_at)->diffForHumans()); ?></span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/siddiq/Desktop/WEB DEV/LISTING/resources/views/users/index.blade.php ENDPATH**/ ?>