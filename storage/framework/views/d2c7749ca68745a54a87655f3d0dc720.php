...
<?php $__env->startSection('content'); ?>
    ...
    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
        <div class="row g-4">
            ...
            <div class="col">
                <div class="p-2">
                    <h3 class="text-white mb-1"><?php echo e($user->detail && $user->detail->f_name && $user->detail->l_name ? $user->detail->f_name . ' ' . $user->detail->l_name : $user->name); ?></h3>
                    <p class="text-white text-opacity-75"><?php echo e($user->detail ? $user->detail->designation : 'N/A'); ?></p>
                    <div class="hstack text-white-50 gap-1">
                        <div class="me-2"><i
                                class="ri-map-pin-user-line me-1 text-white text-opacity-75 fs-16 align-middle"></i><?php echo e($user->detail ? $user->detail->city : ''); ?>,
                            <?php echo e($user->detail ? $user->detail->country : 'N/A'); ?></div>
                        <div><i class="ri-building-line me-1 text-white text-opacity-75 fs-16 align-middle"></i><?php echo e($user->detail ? $user->detail->company : 'N/A'); ?>
            ...
            <div>
                <div class="d-flex profile-wrapper">
                    ...
                    <div class="flex-shrink-0">
                        <a href="<?php echo e(route('profileSettings')); ?>" class="btn btn-success"><i
                                            ...
                                            <table class="table table-borderless mb-0">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-muted"><?php echo e($user->detail ? $user->detail->f_name ." ". $user->detail->l_name : $user->name); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Mobile :</th>
                                                        <td class="text-muted"><?php echo e($user->detail ? $user->detail->phone : ''); ?></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-muted"><?php echo e($user->detail ? $user->detail->city : ''); ?>, <?php echo e($user->detail ? $user->detail->country : ''); ?>. <?php echo e($user->detail ? $user->detail->zip : ''); ?></td>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-wrap gap-2 fs-15">
                                            ...
                                            <?php $__currentLoopData = $skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="javascript:void(0);" class="badge bg-secondary-subtle text-secondary"><?php echo e($skill); ?></a>
                            ...
                            <div class="col-xxl-9">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p><?php echo e($user->detail ? $user->detail->biography : 'Hello, I’m '. $user->name); ?>.</p>
                                        <p>My skills are <?php echo e($user->detail ? $user->detail->skills : 'N/A'); ?></p>
                                        <div class="row">
                                            <div class="col-6 col-md-4">
                                                <div class="d-flex mt-4">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <h6 class="text-truncate mb-0"><?php echo e($user->detail ? $user->detail->designation : 'N/A'); ?></h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-6 col-md-4">
                                                <div class="d-flex mt-4">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <a href="http://<?php echo e($user->detail ? $user->detail->website : 'N/A'); ?>" target="_blank" class="fw-semibold"><?php echo e($user->detail ? $user->detail->website : 'N/A'); ?></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end col-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/siddiq/Desktop/WEB DEV/LISTING/resources/views/users/profile.blade.php ENDPATH**/ ?>