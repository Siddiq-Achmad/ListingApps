...
<?php echo app('translator')->get('translation.answer'); ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="answers-table" class="display table table-bordered dt-responsive nowrap align-middle mdl-data-table" style="width:100%">
                        <thead>
                            <tr>
                                <th>Survey</th>
...
<script src="<?php echo e(URL::asset('build/js/data/surveys/answer.init.js')); ?>"></script>

<script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/siddiq/Desktop/WEB DEV/LISTING/resources/views/surveys/answer.blade.php ENDPATH**/ ?>