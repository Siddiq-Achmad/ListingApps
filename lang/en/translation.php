...
return [
    ...
    "ico-list"=>"ICO List",
    "kyc-application"=>"Pengajuan KYC",
    "invoices"=>"Faktur",
    "details"=>"Detail Faktur",
    "create-invoice"=>"Buat Faktur",
    "supprt-tickets"=>"Tiket Layanan",
    ...
    "lock-screen"=>"Telaah Layar",
    "logout"=>"Keluar",
    "success-message"=>"Pesan Berhasil",
    "two-step-verification"=>"Verifikasi 2 Faktor",
    "errors"=>"Error",
    "404-basic"=>"404 Basic",
    "404-cover"=>"404 Cover",
    "404-alt"=>"404 Alt",
