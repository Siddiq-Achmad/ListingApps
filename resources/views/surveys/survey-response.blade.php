    ...
    <div class="col-xxl-3">
                    ...
                    <table class="table table-borderless align-middle mb-0">
                        <tbody>
                            <tr>
                                ...
                                <td>#<span id="r-no">{{ $response->id }}</span> </td>
                            </tr>
                            <tr>
                                <td class="fw-medium">Respondent Name</td>
                                <td id="r-name">{{ $response->name }}</td>
                            </tr>
                            <tr>
                                <td class="fw-medium">Respondent Email</td>
                                <td id="r-email">{{ $response->email }}</td>
                            </tr>
                            <tr>
                                <td class="fw-medium">Respondent Phone</td>
                                <td id="r-phone">{{ $response->phone }}</td>
                            </tr>
                            <tr>
                                <td class="fw-medium">Respondent Age</td>
                                <td id="r-age">{{ $response->age }}</td>
                            </tr>
                            <tr>
                                <td class="fw-medium">Respondent Gender</td>
                                <td id="r-gender">{{ $response->gender }}</td>
                            </tr>
                            <tr>
                                <td class="fw-medium">Respondent City</td>
                                <td id="r-city">{{ $response->city }}</td>
                            </tr>
                            <tr>
                                <td class="fw-medium">Education Level</td>
                                <td id="r-education">{{ $response->education_level }}</td>
                            </tr>
                            
                            
                            <tr>
                                <td class="fw-medium">Create Date</td>
                                <td id="c-date">{{ \Carbon\Carbon::parse($response->created_at)->format('d M, Y h:i A') }}</td>
                            </tr>
                            <tr>
                                <td class="fw-medium">Update Date</td>
                                <td id="d-date">{{ \Carbon\Carbon::parse($response->updated_at)->format('d M, Y h:i A') }}</td>
                            </tr>
                            <tr>
                                <td class="fw-medium">Last Activity</td>
                                <td>{{ \Carbon\Carbon::parse($response->updated_at)->diffForHumans() }}</td>
                            </tr>
                            <tr>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <h6 class="card-title fw-semibold mb-0 badge bg-primary">{{ $answers->count() }}</h6>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive table-card">
                    <table class="table table-borderless align-middle mb-0">
                        <tbody>
                            <tr>
                                <td class="fw-medium">Question : <span class="badge bg-secondary-subtle text-secondary pl-4">{{ $questions->count() }}</span></td>
                                <td class="fw-medium">Answer : <span class="badge bg-secondary-subtle text-secondary pl-4" >{{ $answers->count() }}</span></td>
                            </tr>
