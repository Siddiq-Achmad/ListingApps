                            ...
                            <table class="table align-middle" id="surveyTable">
                                ...
                                <tbody class="list form-check-all">
                                    ...
                                    <tr>
                                        ...
                                        <td class="status"><span class="badge @if($survey->status == 1) bg-success-subtle text-success @else bg-danger @endif text-uppercase">{{ $survey->status == 1 ? 'Active' : 'Block' }}</span>
                                        </td>
                                        <td>
                                            <ul class="list-inline hstack gap-2 mb-0">
                                                <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                    <a class="edit-btn" href="#editModal" data-bs-toggle="modal" data-id="{{ $survey->id }}" class="text-primary d-inline-block edit-item-btn">
                                                        <i class="ri-pencil-fill fs-16"></i>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Remove">
                                                    <a class="text-danger d-inline-block remove-item-btn" data-id="{{ $survey->id }}" data-bs-toggle="modal" href="#deleteRecordModal" data-bs-target="#deleteRecordModal">
                    ...
                    <div class="modal fade" id="addModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form id="addForm" action="{{ route('surveys.store') }}" method="POST" class="tablelist-form" autocomplete="off">
                                    @csrf
...
@section('script')
    <script>
        ...
        var url = '{{ route('surveys.destroy', ':id') }}';
            ...
            button.addEventListener('click', function() {
                ...
                fetch(`/surveys/${userId}/edit`)
                    ...
                    .then(data => {
                        ...
                        editForm.action = `{{ route('surveys.update', ':id') }}`;
