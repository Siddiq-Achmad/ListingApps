            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarUsers" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarUsers">
                        <i data-feather="users" class="icon-dual"></i> <span>@lang('translation.users-management')</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarUsers">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="#sidebarProfile" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarProfile">@lang('translation.user-profile')
                                </a>
                                <div class="collapse menu-dropdown" id="sidebarProfile">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="profile" class="nav-link">@lang('translation.profile')</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="profile-settings" class="nav-link">@lang('translation.settings')</a>
                                        </li>
                            ...
                            <li class="nav-item">
                                <a href="#sidebarUserLists" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarUserLists">@lang('translation.users-list')
                                </a>
                                <div class="collapse menu-dropdown" id="sidebarUserLists">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ route('users.deleted') }}" class="nav-link">@lang('translation.users-deleted')</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="dashboard-ecommerce" class="nav-link">@lang('translation.ecommerce')</a>
                            </li>
                            <li class="nav-item">
                                <a href="dashboard-crypto" class="nav-link">@lang('translation.crypto')</a>
                            </li>
                            <li class="nav-item">
                                <a href="index" class="nav-link">@lang('translation.projects')</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarApp" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApp">
                        <i data-feather="grid" class="icon-dual"></i> <span>@lang('translation.apps')</span>
                    </a>
