...
document.getElementById("showModal").addEventListener("show.bs.modal", function (e) {
    if (e.relatedTarget.classList.contains("edit-item-btn")) {
        ...
        document.getElementById("showModal").querySelector(".modal-body").style.display = "block";
        document.getElementById("showModal").querySelector(".btn-success").style.display = "block";
        document.getElementById("showModal").querySelector(".view-modal").style.display = "none";
    ...
    }else if(e.relatedTarget.classList.contains("view-item-btn")) {
        document.getElementById("exampleModalLabel").innerHTML = "View Question";
        document.getElementById("showModal").querySelector(".view-modal").style.display = "block";
        document.getElementById("showModal").querySelector(".modal-body").style.display = "none";
        document.getElementById("showModal").querySelector(".btn-success").style.display = "none";
    
    } else {
        document.getElementById("exampleModalLabel").innerHTML = "Question";
        document.getElementById("showModal").querySelector(".btn-success").style.display = "block";
        document.getElementById("showModal").querySelector(".modal-body").style.display = "block";
        document.getElementById("showModal").querySelector(".view-modal").style.display = "none";
        document.getElementById("showModal").querySelector(".btn-success").style.display = "block";
